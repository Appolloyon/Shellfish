...
QUERY_SUB_DIR=/home/cklinger/BLAST_SEARCHES/blastpqueries
DATABASE_SUB_DIR=/home/cklinger/BLAST_SEARCHES/blastpdatabase
...
for database in $DATAFILES; do
	...
	mkdir -p /home/cklinger/"blastp_$q_short_name"
        ...
        blastp -query "$query" -db "$database" -out "blastp_$q_short_name/${q_short_name}_${db_short_name}_${now}.outfile.txt" -outfmt "6 qseqid sseqid evalue"  $BLAST_OPTIONS
    done
done
