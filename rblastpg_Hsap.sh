...
QUERY_SUB_DIR=/home/bioinfor1/cklinger/BLAST_SEARCHES/rblastpqueries_Hsap
DATABASE_SUB_DIR=/home/bioinfor1/cklinger/BLAST_SEARCHES/rblastpdatabase_Hsap
...
for database in $DATAFILES; do
    ...
    for query in $QUERYFILES; do
        ...
        blastp -query "$query" -db "$database" -out "rblastp_$db_short_name/${q_short_name}_${db_short_name}.outfile.txt" $BLAST_OPTIONS
    done
done
