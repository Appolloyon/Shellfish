...
QUERY_SUB_DIR=/home/bioinfor1/cklinger/BLAST_SEARCHES/blastpqueries
DATABASE_SUB_DIR=/home/bioinfor1/cklinger/BLAST_SEARCHES/blastpdatabase
...
DATAFILES=`ls $DATABASE_SUB_DIR/Cvelia.fa`
...
for database in $DATAFILES; do
	...
	mkdir -p /home/bioinfor1/cklinger/"blastp_$q_short_name"
        ...
        blastp -query "$query" -db "$database" -out "blastp_$q_short_name/${q_short_name}_${db_short_name}.outfile.txt" -outfmt "6 qseqid sseqid evalue"  $BLAST_OPTIONS
    done
done
