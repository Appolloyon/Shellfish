...
QUERY_SUB_DIR=/home/cklinger/BLAST_SEARCHES/rblastxqueries_Scer
DATABASE_SUB_DIR=/home/cklinger/BLAST_SEARCHES/rblastxdatabase_Scer
...
for database in $DATAFILES; do
    ...
    mkdir -p /home/cklinger/"rblastx_$db_short_name"
    ...
    for query in $QUERYFILES; do
        ...
        blastx -query "$query" -db "$database" -out "rblastx_$db_short_name/${q_short_name}_${db_short_name}_${now}.outfile.txt" $BLAST_OPTIONS
    done
done
